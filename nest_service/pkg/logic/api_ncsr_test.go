...
import (
	...
	nest_ca "github.com/securityresearchlab/nebula-est/nest_ca/pkg/logic"
	nest_config "github.com/securityresearchlab/nebula-est/nest_config/pkg/logic"
...
func sendNcsrApplication(_ *testing.T, r *gin.Engine, endpoint models.Route, auth models.NestAuth) *httptest.ResponseRecorder {
...
func sendEnroll(_ *testing.T, r *gin.Engine, endpoint models.Route, hostname string, csr *models.NebulaCsr) *httptest.ResponseRecorder {
